...
const file_hello_proto_rawDesc = "" +
	"\n" +
	"\vhello.proto\x12\x04main\x1a\x1cgoogle/api/annotations.proto\"%\n" +
	"\rStringMessage\x12\x14\n" +
	"\x05value\x18\x01 \x01(\tR\x05value2\x98\x01\n" +
	"\vRestService\x12E\n" +
	"\x03Get\x12\x13.main.StringMessage\x1a\x13.main.StringMessage\"\x14\x82\xd3\xe4\x93\x02\x0e\x12\f/get/{value}\x12B\n" +
	"\x04Post\x12\x13.main.StringMessage\x1a\x13.main.StringMessage\"\x10\x82\xd3\xe4\x93\x02\n" +
	":\x01*\"\x05/postB\aZ\x05.;apib\x06proto3"
