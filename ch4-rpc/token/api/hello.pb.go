...
const file_hello_proto_rawDesc = "" +
	...
	"\fHelloService\x122\n" +
	"\n" +
	"SomeMethod\x12\x12.main.HelloRequest\x1a\x10.main.HelloReplyB\tZ\a.;hellob\x06proto3"
...
var file_hello_proto_goTypes = []any{
	(*HelloReply)(nil),   // 0: main.HelloReply
	(*HelloRequest)(nil), // 1: main.HelloRequest
}
var file_hello_proto_depIdxs = []int32{
	1, // 0: main.HelloService.SomeMethod:input_type -> main.HelloRequest
	0, // 1: main.HelloService.SomeMethod:output_type -> main.HelloReply
