...
const file_hello_proto_rawDesc = "" +
	"\n" +
	"\vhello.proto\x12\x04main\x1a\x0fvalidator.proto\"d\n" +
	"\aMessage\x12=\n" +
	"\x10important_string\x18\x01 \x01(\tB\x12\xe2\xdf\x1f\x0e\n" +
	"\f^[a-z]{2-5}$R\x0fimportantString\x12\x1a\n" +
	"\x03age\x18\x02 \x01(\x05B\b\xe2\xdf\x1f\x04\x10\x00\x18dR\x03ageB\tZ\a./;mainb\x06proto3"
